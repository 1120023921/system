    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/index.do#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">页面管理</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/menu.do')">一级菜单管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/secondMenu.do')">二级菜单管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/bodyContent.do')">主页内容管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/picConfig.do')">主页图片管理</a></li>
                        <%--<li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/productMenu.do')">产品管理一级导航</a></li>--%>
                        <%--<li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/secondProductMenu.do')">产品管理二级导航</a></li>--%>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/newsConfig.do')">新闻资讯管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/goToGJConfig.do')">走进广俊管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/humanResourseConfig.do')">人力资源管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/productConfig.do')">产品管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/features.do')">产品特性管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/type.do')">产品类型管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/supplier.do')">产品供应商管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/contactUsConfig.do')">联系我们管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/question.do')">常见问题管理</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/log.do')">日志查看</a></li>
                        <li><a href="#" onclick="menuClick('${pageContext.request.contextPath}/admin/getPv.do')">访问量查看</a></li>
                    </ul>
                </li>
                <%--<li>--%>
        ...
        <div class="navbar-header">
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
            <iframe id="iframe" name = "frame" src="${pageContext.request.contextPath}/user/render.do" width="100%"  frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes"></iframe>
               </div>
            <div class="footer">
            <div class="pull-right">
                                   最终<strong>解释权</strong>DoubleH
            </div>
            <div>
